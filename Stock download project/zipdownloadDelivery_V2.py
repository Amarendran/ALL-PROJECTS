...
start_date = datetime(2024, 5, 25) #yyyymmdd
...
while current_date <= end_date:
    ...
    output_dir = "D:/nse_download/download_withdelivery/"
    output_dir_Temp = "D:/nse_download/"
    ...
    try:
        ...
        df = pd.read_table('D:/nse_download/'+'tempfile.DAT',delimiter=',',index_col=1,skiprows=4,skipfooter=0,names=['Record Type', 'Sr No', 'Name of Security','SERIES','Quantity Traded','Deliverable Quantity','% of Deliverable Quantity'])
