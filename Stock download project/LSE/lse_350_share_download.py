...
browser.get('https://www.londonstockexchange.com/indices/ftse-350/constituents/table')     
try:
...
for i in tqdm(range(1, 19)):
    browser.get(f'https://www.londonstockexchange.com/indices/ftse-350/constituents/table?page={i}') 
    t.sleep(1)
...
big_df.to_csv(path+"LSE_350_companies.csv", index=False, encoding='utf-8-sig')
