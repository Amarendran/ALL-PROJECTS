...
browser.get('https://www.londonstockexchange.com/indices/ftse-all-share/constituents/table')     
try:
...
for i in tqdm(range(1, 30)):
    browser.get(f'https://www.londonstockexchange.com/indices/ftse-all-share/constituents/table?page={i}') 
    t.sleep(1)
...
big_df.to_csv(path+"LSE_All_companies.csv", index=False, encoding='utf-8-sig')
