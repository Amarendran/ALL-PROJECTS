...
browser.get('https://www.londonstockexchange.com/indices/ftse-aim-100-index/constituents/table')     
try:
...
for i in tqdm(range(1, 7)):
    browser.get(f'https://www.londonstockexchange.com/indices/ftse-aim-100-index/constituents/table?page={i}') 
    t.sleep(1)
...
big_df.to_csv(path+"LSE_AIM100_companies.csv", index=False, encoding='utf-8-sig')
