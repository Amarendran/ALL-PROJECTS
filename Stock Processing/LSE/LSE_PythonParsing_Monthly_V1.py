...
combined_csv=pd.read_csv(path+"ftse_combined_csv_Month.csv")
...
#New formula Days 256 , wk 53, month = 12
TRADING_DAYS = 12
...
EQData['VOLATILITY_LOW']=EQData.groupby('SYMBOL',as_index=False,group_keys=False).apply(get_rolling,60,'VOLATILITY','min')
...
EQData.to_csv(path+"LSE_Monthly_combined_csv_processed_output.csv", index=False, encoding='utf-8-sig')
