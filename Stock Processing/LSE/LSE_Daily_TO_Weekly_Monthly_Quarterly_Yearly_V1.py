...
#combined_csv_Week.to_csv(path+"ftse_combined_csv_Week_"+Week_Range+".csv", index=False, encoding='utf-8-sig')
#combined_csv_Month.to_csv(path+"ftse_combined_csv_Month_"+Month_Range+".csv", index=False, encoding='utf-8-sig')
#combined_csv_quarter.to_csv(path+"ftse_combined_csv_Quarter_"+Quarter_Range+".csv", index=False, encoding='utf-8-sig')
#combined_csv_Year.to_csv(path+"ftse_combined_csv_Year_"+Year_Range+".csv", index=False, encoding='utf-8-sig')

combined_csv_Week.to_csv(path2+"ftse_combined_csv_Week.csv", index=False, encoding='utf-8-sig')
combined_csv_Month.to_csv(path2+"ftse_combined_csv_Month.csv", index=False, encoding='utf-8-sig')
