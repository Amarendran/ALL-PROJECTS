...
combined_csv=pd.read_csv(path_readcsv+"ftse_download.csv")
...
print("pivot export")
EQBullish.to_csv(path+"LSE_combined_csv_processed_output_pivort_week.csv", encoding='utf-8-sig')
EQBullishYear.to_csv(path+"LSE_combined_csv_processed_output_pivort_Year.csv", encoding='utf-8-sig')
EQBullishMonth.to_csv(path+"LSE_combined_csv_processed_output_pivort_Month.csv", encoding='utf-8-sig')
EQBullishClose.to_csv(path+"LSE_combined_csv_processed_output_close_pivort_week.csv", encoding='utf-8-sig')
EQBullishCloseYear.to_csv(path+"LSE_combined_csv_processed_output_close_pivort_Year.csv", encoding='utf-8-sig')
EQBullishCloseMonth.to_csv(path+"LSE_combined_csv_processed_output_close_pivort_Month.csv", encoding='utf-8-sig')
