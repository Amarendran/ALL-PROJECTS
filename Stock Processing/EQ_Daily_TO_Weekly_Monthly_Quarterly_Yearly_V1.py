...
#combined_csv.dtypes
#EQData.dtypes
combined_csv=combined_csv[combined_csv.SERIES=='EQ']

combined_csv.drop(columns=['SERIES','LAST'],inplace=True)
...
combined_csv_Week.to_csv(path+"combined_csv_Week_"+Week_Range+".csv", index=False, encoding='utf-8-sig')
